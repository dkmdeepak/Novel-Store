...
function Edit({allNewBook}) {
  ...
  const[bookData,setBookData]=useState({
    id:allNewBook._id,title:allNewBook.title,
    author:allNewBook.author,
    // publishYear:allNewBook.publishYear,
    github:allNewBook.github,
    content:allNewBook.content
    })

  const handleUpdate=async()=>{
    console.log(bookData);
    const { title, author,github,  content } = bookData
    if( !title || !author ||   !github || !content ) {

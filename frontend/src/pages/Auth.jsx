          ...
          <Col sm={12} md={6} lg={12}>
          {
            status?
              <span className='d-flex justify-content-center mt-5'>
                        <div  style={{fontSize:'90px',fontWeight:'50px'
                          ,color:'rgb(1, 168, 45)', marginTop:'3px'}}>
                        Log In
                        <p className='mx-auto' style={{width:'100px', height:'13px',background:'rgb(0, 168, 45)',borderRadius:'30px'}}></p>
                        </div>
                        
              </span>
              :
              <span className='d-flex justify-content-center mt-5'>
                        <div  style={{fontSize:'90px',fontWeight:'30px'
